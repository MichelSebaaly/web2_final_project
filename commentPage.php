  ...
  <body style="margin:0px;overflow-x:hidden;">
  	...
  	<div class="profilePageFrstDiv">
  		<div class="profilePageFrstDivLeft">
  			<table class="profilePageFrstDivLeftTable">
  				<tr class="profilePageFrstDivLeftTableTr">
  					<td id="profilePageFrstDivLeftTableTdId1" onclick="setPage('order');">Orders</td>
  				</tr>
  				<tr class="profilePageFrstDivLeftTableTr">
  					<td id="profilePageFrstDivLeftTableTdId2" onclick="setPage('comments');" class="profilePageFrstDivLeftTableTd">Comments</td>
  				</tr>
  				<tr class="profilePageFrstDivLeftTableTr">
  		...
  		<div class="profilePageFrstDivRight">
  			<table class="profilePageFrstDivRightTable">
  				<tr class="profilePageFrstDivRightTableTr">
  					<td class="profileCommentDesc">Description : </td>
  					<td class="profileCommentTextAreaTd"><textarea id="profileCommentDescTxtAreaId" class="profileCommentDescriptionTxtArea"></textarea></td>
  					<td class="profileCommentBtnTd"><button class="profileCommentAddBtn" onclick="addComment();">add</button></td>
  				</tr>
  				<tr>
  					<th class="profilePageFrstDivRightTableThAllCmnts" colspan="3">
  						<h1>All your comments : </h1><label><?php ?></label>
  					</th>
  				</tr>
  				<tr>
  					<td class="profilePageFrstDivRightTableTdAllCmnts" colspan="3">
  						<div class="profilePageAllCommentsDiv">
  							<table class="CommentPageTableOfOldComments">
  								<tr class="CommentPageTableOfOldCommentsTrTitle">
  									<th class="CommentPageTableOfOldCommentsNumb">Number</th>
  									<th>Text</th>
  									<th class="CommentPageTableOfOldCommentsDate">Date</th>
  								</tr>
  								<?php
									$con = mysqli_connect("localhost", "root", "", "web3") or die("unable to connect");
									$query = "SELECT * FROM comments WHERE user_id = '" . $_SESSION['userId'] . "'";
									$res = mysqli_query($con, $query);
									$numb = 1;
									while ($fetch = mysqli_fetch_assoc($res)) {
										echo "<tr class='CommentPageTableOfOldCommentsTr'><td>" . $numb++ . "</td><td>" . $fetch['description'] . "</td><td>" . $fetch['date'] . "</td></tr>";
									}
									mysqli_close($con);
									?>
