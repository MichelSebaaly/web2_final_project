 ...
 <body style="margin:0px;overflow-x:hidden;">
 	...
 	<div class="regPageDiv">
 		<div class="regPageDivSignUpDiv">
 			<label id="signUpLogInPageDivSignUpDivResponse"><b></b></label>
 			<div class="signUpLogInPageDivLogInDivLabelDiv">
 				<h1>Register</h1>
 			</div>

 			<div class="signUpLogInPageDivRegDivUsrName">
 				<label>Username</label><br><br>
 				<input id="registerPageUserNameId" name="userNameEmail" class="signUpLogInPageDivRegDivUsrNameEmail" placeholder="UserName" />
 			</div>

 			<div class="signUpLogInPageDivRegDivUsrName">
 				<label>Email address</label><br><br>
 				<input id="registerPageEmailId" name="userNameEmail" class="signUpLogInPageDivRegDivUsrNameEmail" placeholder="example@gmail.com" />
 			</div>

 			<br><br>
 			<div class="signUpLogInPageDivRegDivUsrName">
 				<label>Password</label><br><br>
 				<input id="registerPagePasswordId" type="password" name="userPassword" placeholder="**********" class="signUpLogInPageDivRegDivUsrNameEmail" />
 			</div>


 			<div class="signUpLogInPageDivRegDivUsrName">
 				<label>Phone number</label><br><br>
 				<input id="registerPagePhoneNumbId" name="userPhoneNumber" class="signUpLogInPageDivRegDivUsrNameEmail" placeholder="+961 12 345 678" />
 			</div>
 			...
 			<div class="signUpLogInPageDivRegDivUsrName">
 				...
 				<input id="regAddAddressLineId" name="addressLine" class="addAddressLineClass" placeholder="555" />
 			</div>


 			<div class="signUpLogInPageDivRegDivUsrName">
 				<label>City</label><br><br>
 				<input id="regAddAddressCityId" name="addressCity" class="addAddressLineClass" placeholder="beirut" />
 			</div>
 			...
 			<div class="signUpLogInPageDivRegDivUsrName">
 				...
 				<input id="regAddAddressNearToId" name="addressNearTo" class="addAddressLineClass" placeholder="nothing" />
 			</div>

 			<div class="signUpLogInPageDivRegDivUsrName">
 				<label>Country</label><br><br>
 				<input id="regAddAddressCountryId" name="addressCountry" class="addAddressLineClass" value="Lebanon" disabled />
 			</div>

 			<br><br>

 			<button id="signUpLogInPageDivRegButtonId" class="signUpLogInPageDivRegButton" onclick="registerUser();"><b>Register</b></button>
 		</div>
 	</div>
 	...
 	<script>
 		...
 		$("#regAddNewAddressId").click(function() {
 			window.location.href = "newLocationToAdd.php";
 		})
