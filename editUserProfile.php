 ...
 <body style="margin:0px;overflow-x:hidden;">
 	...
 	<div class="editProfilePageFrstDiv">
 		<div class="editProfilePageFrstDivUserName">
 			<div class="editProfilePageFrstDivUserNameLeftDiv">
 				<label>User Name</label>
 			</div>
 			<div class="editProfilePageFrstDivUserNameRightDiv">
 				<textarea class="editProfilePageFrstDivUserNameRightDivTxtArea" id="edtProfileUserNameTextAreaId"><?php echo $_SESSION['userName']; ?></textarea>
 			</div>
 		</div>

 		<div class="editProfilePageFrstDivUserPass">
 			<div class="editProfilePageFrstDivUserNameLeftDiv">
 				<label>Email</label>
 			</div>
 			<div class="editProfilePageFrstDivUserNameRightDiv">
 				<textarea class="editProfilePageFrstDivUserNameRightDivTxtArea" id="edtProfileEmailTextAreaId"><?php echo $_SESSION['email']; ?></textarea>
 			</div>
 		</div>

 		<div class="editProfilePageFrstDivUserEmail">
 			<div class="editProfilePageFrstDivUserNameLeftDiv">
 				<label>Password</label>
 			</div>
 			<div class="editProfilePageFrstDivUserNameRightDiv">
 				<textarea class="editProfilePageFrstDivUserNameRightDivTxtArea" id="edtProfileUserPasswordAreaId"><?php echo $_SESSION['password']; ?></textarea>
 			</div>
 		</div>

 		<div class="editProfilePageFrstDivUserPhoneNumb">
 			<div class="editProfilePageFrstDivUserNameLeftDiv">
 				<label>phone Number</label>
 			</div>
 			<div class="editProfilePageFrstDivUserNameRightDiv">
 				<textarea class="editProfilePageFrstDivUserNameRightDivTxtArea" id="edtProfilePhoneNumbTextAreaId"><?php echo $_SESSION['phoneNumb']; ?></textarea>
 			</div>

 		</div>

 		<div class="editProfilePageFrstDivUserAddress">
 			<div class="editProfilePageFrstDivAddressLeftDiv">
 				<label>Address</label>
 			</div>
 			<div class="editProfilePageFrstDivAddressRightDiv">
 				<table class="editProfileTableAddressDiv">
 					<tr class="editProfileTableAddressDivTr">
 						<td class="editProfileTableAddressDivTdLeft">address line</td>
 						<td><textarea id="edtProfTableRightTxtAreaLineId" class="edtProfTableRightTxtArea"><?php echo $_SESSION['addressLine']; ?></textarea></td>
 					</tr>
 					<tr class="editProfileTableAddressDivTr">
 						<td class="editProfileTableAddressDivTdLeft">city</td>
 						<td><textarea id="edtProfTableRightTxtAreaCityId" class="edtProfTableRightTxtArea"><?php echo $_SESSION['addressCity']; ?></textarea></td>
 					</tr>
 					<tr class="editProfileTableAddressDivTr">
 						<td class="editProfileTableAddressDivTdLeft">near to</td>
 						<td><textarea id="edtProfTableRightTxtAreaNearToId" class="edtProfTableRightTxtArea"><?php echo $_SESSION['addressNearTo']; ?></textarea></td>
 					</tr>
 				</table>
 			</div>
 		</div>
 	...
 	<div class="editProfDiv">
 		<button class="edtProfileBtn" id="edtProfileSaveBtnId" onclick="edtProfileSave();">Save</button>
 	</div>
