...
<body style="margin:0px;overflow-x:hidden;">
	...
	<div class="profilePageFrstDiv">
		<div class="profilePageFrstDivLeft">
			<table class="profilePageFrstDivLeftTable">
				...
				<tr class="profilePageFrstDivLeftTableTr">
					<td id="profilePageFrstDivLeftTableTdId3" onclick="setPage('profile');" class="profilePageFrstDivLeftTableTd">profile</td>
				</tr>
			</table>
		</div>
		<div class="profilePageFrstDivRight">
			<table class="profilePageFrstDivRightTable">
				...
				<tr class="profilePageFrstDivRightTableTr">
					<td>phone number : <label><?php if (!empty($phoneNumb)) {
													echo $phoneNumb;
												} else {
													echo "null";
												}; ?></label></td>
				...
				<tr class="profilePageFrstDivRightTableTr">
					<td>email : <label><?php if (!empty($email)) {
											echo $email;
										} else {
											echo "null";
										} ?></label></td>
				...
				<tr class="profilePageFrstDivRightTableTr">
					<td>created at : <label><?php if (!empty($createdAt)) {
												echo $createdAt;
											} else {
												echo "null";
											} ?></label></td>
	...
	<div class="editProfDiv">
		<button id="editUserProfileId" class="edtProfileBtn">Edit</button>
	</div>
	...
	<script>
		...
		$("#editUserProfileId").click(function() {
