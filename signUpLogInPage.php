 ...
 <body style="margin:0px;overflow-x:hidden;">
 	...
 	<div class="signUpLogInPageDiv">
 		<div class="signUpLogInPageDivLogInDiv">
 			...
 			<div class="signUpLogInPageDivLogInDivUsrName">
 				...
 				<input id="userNameEmailId" name="userNameEmail" class="signUpLogInPageDivLogInDivUsrNameEmail" />
 			</div>
 			<br><br><br>
 			<div class="signUpLogInPageDivLogInDivUsrName">
 				<label>Password</label><br><br>
 				<input id="userPasswordId" type="password" name="userPassword" class="signUpLogInPageDivLogInDivUsrNameEmail" />
 			</div>
 			<br><br>
 			<label id="forgetPasslogInId" class="forgetPass" onclick="forgetPassword();">Forget Password?</label>
 			<br><br>
 			<label id="logInPageAdminId" class="logInPageAdmin">I am admin</label>
 			<br><br><br>
 			<button id="signUpLogInPageDivButtonId" class="signUpLogInPageDivLogInButton" onclick="loginUser(this.id);"><b>Log In</b></button>
 		</div>
 	</div>
 	...
 	<script>
 		...
 		$("#logInPageAdminId").click(function() {
